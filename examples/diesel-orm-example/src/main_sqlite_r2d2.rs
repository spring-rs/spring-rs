...
use spring_diesel_orm::diesel_sync::{DieselSyncOrmPlugin, SqliteR2d2ConnectionPool};
use spring_web::get;
use spring_web::{
...
#[get("/users")]
async fn get_users(Component(db): Component<SqliteR2d2ConnectionPool>) -> Result<impl IntoResponse> {
