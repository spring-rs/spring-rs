...
use spring_diesel_orm::diesel_async::{DieselAsyncOrmPlugin, MysqlDeadPoolConnectionPool};
use spring_web::get;
use spring_web::{
...
#[get("/users")]
async fn get_users(Component(db): Component<MysqlDeadPoolConnectionPool>) -> Result<impl IntoResponse> {
