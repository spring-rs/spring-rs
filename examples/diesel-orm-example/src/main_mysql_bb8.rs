...
use spring_diesel_orm::diesel_async::{DieselAsyncOrmPlugin, MysqlBb8ConnectionPool};
use spring_web::get;
use spring_web::{
...
#[get("/users")]
async fn get_users(Component(db): Component<MysqlBb8ConnectionPool>) -> Result<impl IntoResponse> {
